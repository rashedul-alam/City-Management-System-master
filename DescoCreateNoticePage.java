...
public class DescoCreateNoticePage extends JFrame implements MouseListener, ActionListener
{
	...
	public DescoCreateNoticePage(String userId,String uname)
	{
		super("Desco Create Notice Page");
	...
	{
		Date date=new Date();
		String query = "INSERT INTO `desconoticetable` (`date`,`descoNotice`) VALUES ('"+date.toString()+"','"+createNoticeF.getText()+"');";
