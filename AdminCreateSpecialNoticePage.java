...
public class AdminCreateSpecialNoticePage extends JFrame implements MouseListener, ActionListener
{
	...
	public AdminCreateSpecialNoticePage(String userId,String uname)
	{
		super("Admin Create Special Notice Page");
		this.setSize(1200,675);
		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		panel = new JPanel();
		panel.setLayout(null);
		
		createNotice=new JLabel("Create Special Notice : ");
		createNotice.setBounds(350,250,200,20);
	...
	{
		Date date=new Date();
		String query = "INSERT INTO `specialnotice` (`date`,`notice`) VALUES ('"+date.toString()+"','"+createNoticeF.getText()+"');";
        ...
        try
		{
			...
			stm.close();
			con.close();
			JOptionPane.showMessageDialog(this,"Special Notice Created");
			AdminPage a=new AdminPage(u,name);
			a.setVisible(true);
			this.setVisible(false);			
		}
