...
public class AdminCreateNoticePage extends JFrame implements MouseListener, ActionListener
{
	...
	public AdminCreateNoticePage(String userId,String uname)
	{
		super("Admin Create Notice Page");
	...
	{
		Date date=new Date();
		String query = "INSERT INTO `adminnoticetable` (`date`,`adminNotice`) VALUES ('"+date.toString()+"','"+createNoticeF.getText()+"');";
