...
public class DescoSeeObjectionPage extends JFrame implements MouseListener, ActionListener
{
	...
	public DescoSeeObjectionPage(String userId,String uname)
	{
		super("Desco See Objection Page");
		...
		String []col={"UserID","AccountHolderName","Address","ObjectionAgainstDesco"};
		
		objection=new JLabel("Objection Against Desco");
	...
	public void check()
	{
        ...
        try
		{
			...
			while(rs.next())
			{
				...
				else if(accountType.equals("desco") && uId.equals(u))
				{	
