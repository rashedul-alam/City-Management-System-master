...
public class DescoBillPage extends JFrame implements MouseListener, ActionListener
{
	...
	public DescoBillPage(String ui,String uname)
	{	
		super("Desco Bill Page");
	...
	public void updateInDB()
	{
		...
		{
			System.out.println("."); 
			query = "UPDATE `projectjava` SET `electricityBill`='"+newBill+"' where `projectjava`.`userId` ='"+userIdF.getText().toString()+"';";
