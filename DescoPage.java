...
public class DescoPage extends JFrame implements MouseListener, ActionListener
{
	...
	public DescoPage(String userId,String uname)
	{
		super("Desco Page");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			DescoBillPage dbp=new DescoBillPage(u,name);
			dbp.setVisible(true);
			this.setVisible(false);
		}
		else if(elementText.equals(seeObjection.getText()))
		{
			DescoSeeObjectionPage d=new DescoSeeObjectionPage(u,name);
			d.setVisible(true);
			this.setVisible(false);
		}
		else if(elementText.equals(addHomeOwner.getText()))
		{
			AddHomeOwnerDescoPage a=new AddHomeOwnerDescoPage(u,name);
			a.setVisible(true);
			this.setVisible(false);
		}
		else if(elementText.equals(createNotice.getText()))
		{
			DescoCreateNoticePage d=new DescoCreateNoticePage(u,name);
			d.setVisible(true);
			this.setVisible(false);
		}
