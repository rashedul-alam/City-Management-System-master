...
public class AddHomeOwnerDescoPage extends JFrame implements MouseListener, ActionListener
{
	...
	public AddHomeOwnerDescoPage(String u,String uname)
	{	
		super("Add Home Owner Desco Page");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			DescoPage d=new DescoPage(uid,name);
			d.setVisible(true);
	...
	public void updateInDB()
	{
		...
		{
			System.out.println("."); 
			query = "UPDATE `projectjava` SET `electricityLineType`='"+type+"' where `projectjava`.`userId` ='"+homeOwnerIdF.getText().toString()+"';";
